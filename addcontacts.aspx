<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addcontacts.aspx.cs" Inherits="ContactManager.addcontacts" MaintainScrollPositionOnPostback="true"%>
...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    ============================-->
    <div class="hero">
        <img src="img/businesscontact.jpg" class="responsive" style="width: 100%; height: 900px;"/>
        <div class="hero-text">
            <h1 style="font-size:50px; text-align: left;">Business Contact Registration</h1>
        </div>
    </div>
    <br />
    <br /><!-- #hero -->
...
&nbsp;<asp:TextBox ID="txtBusiness" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ForeColor="Red" ControlToValidate="txtBusiness" ErrorMessage="Required Field"></asp:RequiredFieldValidator>
    </p>
    <p>
