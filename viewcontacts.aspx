<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewcontacts.aspx.cs" Inherits="ContactManager.viewcontacts" MaintainScrollPositionOnPostback="true"%>
...
<body data-spy="scroll" data-target="#navbar-example">
    ...
    ============================-->
    <div class="hero">
        <img src="img/viewcontacts.jpg" class="responsive" style="width: 100%; height: 800px;"/>
        <div class="hero-text">
            <h1 style="font-size:50px; text-align: left;">Business Contacts</h1>
        </div>
    </div>
    <br />
    <br /><!-- #hero -->
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <asp:Label ID="lblFirstName" runat="server" Text="Enter Employee First Name:"></asp:Label>
        <br />
        <asp:TextBox ID="txtFirstName" runat="server" ></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="lblLastName" runat="server" Text="Enter Employee Last Name:"></asp:Label>
        <br />
        <asp:TextBox ID="txtLastName" runat="server" ></asp:TextBox>
        <br />
        <br />
        <asp:Label ID="lblEmail" runat="server" Text="Enter Employee Email:"></asp:Label>
        <br />
        ...
        <br />
        <p>
        <asp:Label ID="lblMessage" runat="server" ForeColor="Red" Visible="False" Text="You Successfully modified the contact listing!"></asp:Label>

            <asp:Label ID="lblUpdateMessage" runat="server" ForeColor="Red" Visible="False" Text="You Successfully updated the contact listing!"></asp:Label>

            <asp:Label ID="lblDeleteMessage" runat="server" ForeColor="Red" Visible="False" Text="You Successfully deleted the contact listing!"></asp:Label>
    </p>
